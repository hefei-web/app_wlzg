<template>
  <div class="error">
    <div id="wrap">
      <div>
        <img src="http://127.0.0.1:3000/img/404.png" alt="404" />
      </div>
      <div id="text">
        <strong>
          <span></span>
...
#text span {
  width: 128px;
  height: 29px;
  background: url(http://127.0.1:3000/img/info.png) no-repeat;
}
#text a {
  line-height: 14px;
  color: #fff;
...
.below {
  height: 173px;
  background: url(http://127.1:3000/img/below.png) no-repeat;
}
.above {
  height: 149px;
  background: url(http://127.1:3000/img/above.png) no-repeat -60px 0;
