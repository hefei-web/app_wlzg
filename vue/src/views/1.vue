<template>
    <div class="container" draggable="false" @mousedown="returnFalse">
        <div class="album" ref="album" @mousedown="returnFalse">
            <img src="../assets/home_1.png" alt="" width="350" height="200">
            <img src="../assets/home_2.png" alt="" width="350" height="200">
            <img src="../assets/home_3.png" alt="" width="350" height="200">
            <img src="../assets/home4.png" alt="" width="350" height="200">
